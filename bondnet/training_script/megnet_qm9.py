...
from bondnet.model.meg_mol import MEGMol
from bondnet.data.dataset import train_validation_test_split
from bondnet.data.qm9 import QM9Dataset
from bondnet.data.dataloader import DataLoader
...
def parse_args():
    parser = argparse.ArgumentParser(description="MEGMol")
    ...
    parser.add_argument(
        "--num-fc-layers", type=int, default=2, help="number of feed-forward layers"
    )
    parser.add_argument(
        "--fc-hidden-size",
        type=int,
